...
exports.RecommendationUser = exports.MangaRecommendation = exports.AnimeRecommendation = exports.BaseRecommendation = void 0;
...
class AnimeRecommendation extends BaseRecommendation {
    constructor(client, data) {
        var _a;
        super(client, data);
...
class MangaRecommendation extends BaseRecommendation {
    constructor(client, data) {
        var _a;
        super(client, data);
